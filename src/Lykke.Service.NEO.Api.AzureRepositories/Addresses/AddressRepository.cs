...
namespace Lykke.Service.NEO.Api.AzureRepositories.Addresses
{
    public class AddressRepository : IAddressRepository
    {
        ...
        {
            _balanceAddressesStorage = AzureTableStorage<BalanceAddressEntity>.Create(connectionStringManager, "NEOBalanceAddresses", log);
            _historyAddressesStorage = AzureTableStorage<HistoryAddressEntity>.Create(connectionStringManager, "NEOHistoryAddresses", log);
        }
