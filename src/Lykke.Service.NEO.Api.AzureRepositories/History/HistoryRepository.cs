...
using Lykke.Service.NEO.Api.Core.Domain;
...
namespace Lykke.Service.NEO.Api.AzureRepositories.History
{
    public class HistoryRepository : IHistoryRepository
    {
        ...
        {
            _historyStorage = AzureTableStorage<HistoryItemEntity>.Create(connectionStringManager, "NEOHistory", log);
            _indexStorage = AzureTableStorage<IndexEntity>.Create(connectionStringManager, "NEOHistoryIndex", log);
        }
