...
namespace Lykke.Service.NEO.Api.AzureRepositories.Operations
{
    public class OperationRepository : IOperationRepository
    {
        ...
        {
            _log = log;
            _operationStorage = AzureTableStorage<OperationEntity>.Create(connectionStringManager, "NEOOperations", log);
            _operationItemStorage = AzureTableStorage<OperationItemEntity>.Create(connectionStringManager, "NEOOperationItems", log);
            _indexStorage = AzureTableStorage<IndexEntity>.Create(connectionStringManager, "NEOOperationIndex", log);
            _expirationStorage = AzureTableStorage<TableEntity>.Create(connectionStringManager, "NEOOperationExpiration", log);
        }
