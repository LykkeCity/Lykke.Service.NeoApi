...
autorest --input-file=http://localhost:5000/swagger/v1/swagger.json --csharp --output-folder=./client/Lykke.Service.NEO.Api.Client/AutorestClient --namespace=Lykke.Service.NEO.Api.Client.AutorestClient